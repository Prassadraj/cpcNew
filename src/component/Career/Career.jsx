        ...
        <div className=" mt-10 font-poppins">
          ...
          <header>
            <div className="grid md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 ">
              ...
              <div
                className="md:ml-20 lg:ml-20 xl:ml-20 mt-10 p-4"
                data-aos="flip-left"
              >
                <h2 className="md:text-left text-cpccol text-3xl font-poppins font-semibold">
                  CPC Diagnositcs
                </h2>
                <p className="text-xl mt-4 font-poppins">Careers</p>
                <div className="md:pr-5 lg:pr-5 xl:pr-5">
                  <p className="mt-2 text-justify leading-7 text-fontextra font-poppins">
                    Join our dynamic team where your growth is our priority. We
                    empower your skills, encourage innovation, and together,
                    shape the future of healthcare diagnostics. Be a part of a
                    company that values your contribution.
                  </p>
                </div>
                <div className="mt-4 ">
                  <a href="#applynow">
                    <button
                      type="submit"
                      className="bg-cpccol p-3 text-white hover:shadow-lg transition-all ease-in-out hover:-translate-y-1 text-fontptag"
                    >
                      Apply Now
                    </button>
                  </a>
          ...
          <div className="grid md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 p-16 gap-8 items-center  mt-2  ">
            <div className="leading-8" data-aos="flip-up">
              <h1 className="text-cpccol md:text-4xl xl:text-4xl lg:text-4xl text-xl font-bold text-left ">
                Employee Career Matching
              </h1>
              <p className=" mt-6 md:text-xl lg:text-xl xl:text-xl ">
                Couldn't find the suitable Job? Upload your CV and we will reach
                out to you shortly.
              </p>
              <div className="md:flex lg:flex xl:flex gap-4  mt-8">
                ...
                <label
                  htmlFor="file-upload"
                  className="md:w-72 lg:w-72 xl:w-72 w-full  px-4 py-2 border shadow-lg border-gray-300 rounded-l-md bg-white text-gray-700 cursor-pointer focus:outline-none focus:ring-2 focus:ring-blue-500"
                >
                ...
                <button className="bg-cpccol text-white px-4 rounded-r-md shadow-lg hover:bg-green-300 focus:outline-none focus:ring-2 focus:ring-blue-500 ml-1">
                  Upload
                </button>
              </div>
              <p className="mt-8 text-fontptag">
          ...
          <div className=" md:p-8 lg:p-8 xl:p-8 mt-2 bg-gray-50 rounded-t-full">
            <h2 className="text-2xl text-center text-black">
              Looking for{" "}
              <span className="text-4xl text-cpccol font-semibold">
                {" "}
                Intern
              </span>{" "}
              Opportunities
            ...
            <div className="grid md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 md:p-12 lg:p-12 xl:p-12 gap-5">
              <div className="">
                <h2 className="md:text-2xl lg:text-2xl xl:text-2xl text-lg text-cpccol font-semibold mt-3">
                  Real-World Experience
                </h2>
                <p className="mt-4 text-fontextra pr-10 md:ml-0 lg:ml-0 xl:ml-0 ml-10 text-justify">
                  Work on live projects that impact the healthcare industry and
                  make a difference in people’s lives.
                </p>
              </div>
              <div className="">
                <h2 className="md:text-2xl lg:text-2xl xl:text-2xl text-lg font-semibold text-black mt-3">
                  Mentorship and Training
                </h2>
                <p className="mt-4 text-fontextra pr-10 md:ml-0 lg:ml-0 xl:ml-0 ml-10 text-justify">
                  Learn from experienced professionals who are leaders in their
                  fields and are dedicated to helping you grow.
                </p>
              </div>
              <div className="mt-8">
                <h2 className="md:text-2xl lg:text-2xl xl:text-2xl text-lg font-semibold text-black mt-3">
                ...
                <p className="mt-4 text-fontextra pr-10 md:ml-0 lg:ml-0 xl:ml-0 ml-10 text-justify">
                  Be part of a team that thrives on creativity, collaboration,
                  and pushing boundaries to achieve excellence.
                </p>
              </div>
              <div className="mt-8">
                <h2 className="md:text-2xl lg:text-2xl xl:text-2xl text-lg text-cpccol font-semibold mt-3">
                ...
                <p className="mt-4 text-fontextra pr-10 md:ml-0 lg:ml-0 xl:ml-0 ml-10 text-justify">
                  Gain valuable skills and insights that will set you up for
            ...
            <div className="flex justify-center mt-5">
              <button
                type="submit"
                className="bg-cpccol text-fontptag text-white px-6 py-2 rounded-r-md hover:bg-green-300 focus:outline-none focus:ring-2 focus:ring-blue-500 ml-1"
          ...
          <div className="bg-shade p-2 mt-5">
            <h3
              className="font-semibold mt-4 mb-4 bg-shade text-3xl text-cpccol text-center"
              id="applynow"
            >
              Current Openings
            </h3>
            ...
            <main className="bg-white rounded-lg" id="openings">
              <div className="md:flex lg:flex xl:flex md:gap-10 lg:gap-10 xl:gap-10 p-3">
                <div className="mt-8">
                  ...
                  <h4 className="font-medium mt-4 text-fontptag">
                ...
                <div className="mt-2">
                  ...
                  <h2 className="text-lg mt-3 text-cpccol font-semibold text-left ml-8">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 p-3">
                    {filteredJobs.map((job, index) => (
                      <div
                        key={index}
                        className="group p-6 bg-shade rounded-lg leading-8 shadow-md hover:shadow-lg w-full"
                      >
                        <h3 className="font-semibold text-cpccol text-lg">
                          {job.title}
                        </h3>

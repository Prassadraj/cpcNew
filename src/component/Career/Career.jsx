    ...
    <div className=" mt-10 font-poppins">
          ...
          >
            ...
            <div className="md:pr-5 lg:pr-5 xl:pr-5">
              <p className="mt-2 text-justify leading-7 text-fontextra font-poppins">
                ...
                empower your skills, encourage innovation, and together, shape
                the future of healthcare diagnostics. Be a part of a company
                that values your contribution.
              </p>
            </div>
            <div className="mt-4 ">
              <a href="#applynow">
      ...
      <div className="grid md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 p-16 gap-8 items-center  mt-2  ">
        <div className="leading-8" data-aos="flip-up">
          ...
          <p className=" mt-6 md:text-xl lg:text-xl xl:text-xl ">
            Couldn't find the suitable Job? Upload your CV and we will reach out
            to you shortly.
          </p>
      ...
      <div className=" md:p-8 lg:p-8 xl:p-8 mt-2 bg-gray-50 rounded-t-full">
        <h2 className="text-2xl text-center text-black">
          Looking for{" "}
          <span className="text-4xl text-cpccol font-semibold"> Intern</span>{" "}
          Opportunities
        </h2>
        <div className="grid md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 md:p-12 lg:p-12 xl:p-12 gap-5">
          <div className="">
            ...
            <p className="mt-4 text-fontextra pr-10 md:ml-0 lg:ml-0 xl:ml-0 ml-10 text-justify">
              Work on live projects that impact the healthcare industry and make
          ...
          <div className="mt-8">
            ...
            <p className="mt-4 text-fontextra pr-10 md:ml-0 lg:ml-0 xl:ml-0 ml-10 text-justify">
              Be part of a team that thrives on creativity, collaboration, and
          ...
          <div className="mt-8">
            ...
            <p className="mt-4 text-fontextra pr-10 md:ml-0 lg:ml-0 xl:ml-0 ml-10 text-justify">
              Gain valuable skills and insights that will set you up for success
              in your career.
            </p>
          </div>
        </div>

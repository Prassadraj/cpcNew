    ...
    <div className="text-black poppins">
      ...
      <div className="grid grid-cols-3 mt-10 gap-5 p-16 ">
        <div className="shadow-lg text-center p-5">
          ...
          <p className="mt-4 leading-7">
            ...
            itaque explicabo dicta voluptas, vel accusamus laboriosam provident
            molestiae quaerat{" "}
          </p>
        </div>
        ...
        <div className="shadow-lg text-center p-5">
          ...
          <p className="mt-4 leading-7">
            Providing Endless Opportunities & Unmatched Capabilities Lorem ipsum
            dolor sit amet consectetur, adipisicing elit. Tenetur delectus iusto
            sapiente iure ducimus dolor velit{" "}
          </p>
        </div>
        ...
        <div className="shadow-lg text-center p-5">
          ...
          <p className="mt-4 leading-7">
            on Fortune's World's Most Admired Companies and #1 in our industry.
        ...
        <div className="shadow-lg text-center p-5">
          <h2>
            <span className="text-3xl text-cpccol font-semibold">Search</span>{" "}
            More from here
          </h2>
          <button type="submit" className="mt-10 border-2 p-2 border-cpccol ">
            Search
          </button>
        </div>
      </div>
      ...
      <div className="p-10 bg-gray-50 rounded-l-full">
        ...
        <p className="text-center mt-4">
          ...
          interaction – with our customers, suppliers, and partners, and with
          each other. <br />
          These four values are the very foundation of our culture.
        </p>
        <div className="grid grid-cols-2 p-12 gap-5">
          <div className="">
            <h2 className="text-2xl text-cpccol font-semibold">Integrity</h2>
            <p className="mt-4">
          ...
          <div className="mt-8">
            <h2 className="text-2xl text-cpccol font-semibold">Involvement </h2>
            <p className="mt-4">
              We honor commitments, communicate openly, and demonstrate the
              highest ethical standards.
            </p>
      ...
      <div className="bg-gray-100 p-3 mt-20">
        <h2 className="text-2xl mt-16 ml-16">
          Define your search.{" "}
          <span className="bg-cpccol text-white p-2">Search Our openings</span>{" "}
        </h2>

...
const blogs = [
  ...
  //second blog
  {
    ...
    content:     "Hematology analyzers, also known as CBC machines, are classified into fully automatic and...",
  },
  //third blog
  {
    id: 3,
    ...
    content:      "From routine checkups to complex diseases, there's a hidden force behind your diagnosis....",
  },
  //fourth blog
  {
    id: 4,
    ...
    content:      "Blood disorders occur when the cells in the blood do not function as they should....",
  },
  //fifth blog
  {
    id: 5,
    ...
    content:      "An introduction to a fully automated immunoassay (IA) analyzer. A detailed description....",
  },
   //sixth blog
   {
    id: 6,
    ...
    content:      "In this article, you will be learning to use Hematology Analyzers by by reading and....",
  },
   //seventh blog
   {
    id: 7,
    title: "Basics of 3 part Hematology Analyzer – Every Laboratarians should know",
    admin: "by Mohana Priya ",
    date: "Feb 13, 2023",
    image: blog7,
    alt:'Basics of 3 part Hematology Analyzer – Every Laboratarians should know',
    content:      "3-part differential hematology analyzer  which analyzes the complete blood count....",
  },
   //eighth blog
   {
    id: 8,
    ...
    content:      "The urinary excretion of albumin greater than or equal to 30mg/day is defined....",
  },
    //ninth blog
    {
      id: 9,
      ...
      image: blog9,
      alt:'Allergies',
      content:      "An allergic reaction happens when your body reacts to something that’s normally....",
    },
      ...
      //tenth blog
      {
        ...
        image: blog10,
        alt:'Allergies',
        content:      "Early diagnosis of medical conditions helps in better prognosis and outcomes. This is certainly.......",
      },
      //eleventh blog
      {
        id: 11,
      ...
      //Twelveth blog
      {
        ...
        image: blog12,
        alt:'Allergies',
        content:      "Rheumatoid factor (RF) is the auto antibody generated against IgG due to the activation of B cells..........",
      },
      //thirteenth blog
      {
        id: 13,
        ...
        image: blog13,
        alt:'Allergies',
        content:      " Lipid profile or Lipid panel is a group of tests that measure the amount of cholesterol and..........",
      },
      //Fourteenth blog
      {
        id: 14,
        ...
        image: blog14,
        alt:'Allergies',
        content:      "A heart attack (myocardial infarction) usually occurs when a blood clot blocks blood flow to the..........",
      },
      //Fifteenth blog
      {
        id: 15,
        ...
        image: blog15,
        alt:'Allergies',
        content:      "Blood disorders occur when the cells in the blood do not function as they should, causing certain symptoms..........",
      },
      //sixteenth blog
      {
        id: 16,
        ...
        image: blog16,
        alt:'Allergies',
        content:      "Overview Dietary lipids are transported inside the body through lipoproteins after getting..........",
      },
      //seventeenth blog
      {
        id: 17,
        ...
        image: blog17,
        alt:'Allergies',
        content:      "What is Anti-Phospholipid Syndrome (APS) ? Anti- Phospholipid syndrome is a rare autoimmune..........",
      },
      //Eighteenth blog
      {
        id: 18,
        ...
        image: blog18,
        alt:'Allergies',
        content:      "Scleroderma – The disease: Systemic sclerosis (SSc, scleroderma) is a rare and complex autoimmune..........",
      },
];
    ...
    >
      <div className="shadow-custom-shadow rounded-xl flex flex-col h-full">
        ...
        <div className="px-2 py-1 flex-grow">
          ...
          <p className="mt-2 text-sm text-black">{blog.admin} | {blog.date}</p>

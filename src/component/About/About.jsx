        ...
        <div className="p-4 col-span-7 ">
          ...
          <div className="md:pl-10 md:pr-10 mt-2 text-justify">
            <p className="text-fontextra">
              ...
              laboratory equipment in South Asia, we strive to improve access to
              advanced healthcare technologies and enhance patient outcomes.
            </p>
          </div>
          <div className="p-4 ">
      ...
      <div className="grid md:grid-cols-12 grid-cols-12  gap-2  p-20 animate-fade-up delay-100">
        ...
        <div className="md:col-span-12 col-span-12 md:text-center z-20 ">
          ...
          <p className="text-lg md:pl-40 md:pr-40 text-center">
            ...
            relationships and improve health and quality of life across Asia.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-12 sm:grid-cols-2  gap-2 mt-10 animate-fade-up delay-200">
          ...
          <div className="col-span-7 p-4 mt-20">
            ...
            <p className="ml-2 mt-6 text-justify text-md text-fontextra">
              ...
              to our suppliers, customers, employees, and stakeholders. Our
              commitments include:
            </p>
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg shadow-lg p-6 max-w-5xl">
                  ...
                  <p className="text-lg text-justify">
                    ...
                    Indian Bank as an officer. He has guided the firm for its
                    financial needs, while using his marketing skills to good
                    use in establishing substantial business for the company in
                    Tamil Nadu & Andhra Pradesh. He is a self-taught electronics
                    expert who nurtured and developed our customer support
                    division.
                  </p>
                  <button
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg shadow-lg p-6 max-w-5xl">
                  ...
                  <p className="text-lg">
                    ...
                    the Everlife platform, including M&A strategy, driving
                    company and principal performance and realizing synergies
                    across Everlife’s portfolio of companies.
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    In his previous position as Senior Vice President for India
                    & South-East Asia with Smith & Nephew, Raman built a
                    foundation of strong growth, sustainably gaining shares
                    across businesses in five years while increasing margins.
                    <br />
                    <br />
                    Raman brings expertise in developing and executing business
                    growth strategies across industry segments and geographies.
                    <br />
                    <br />
                    Over the course of two decades he has built strong teams in
                    complex dynamic environments, delivering sustainable
                    financial and operating success. Prior to Smith & Nephew, he
                    held leadership roles at Baxter and Allergan.
                  </p>
                  <button
                    className="mt-4 bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600"
                    onClick={() => togglePopup("card2")}
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg shadow-lg p-6 max-w-5xl">
                  ...
                  <p className="text-lg">
                    ...
                    industry throughout the region. She started her career in
                    market research, before joining the Sanofi Business
                    Development team leading regional asset licensing projects.
                    <br />
                    <br />
                    In 2010, she moved to China to manage Sanofi’s outsourced
                    portfolio and lead license-in projects. Prior to joining
                    Everlife, she was Director of Operations for a genetic
                    testing start-up in Shanghai.
                    <br />
                    <br />
                    Chermayn graduated from the University of Pennsylvania with
                    a double major in Biology and Economics.
                  </p>
                  <button
                    className="mt-4 bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600"
                    onClick={() => togglePopup("card3")}
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg shadow-lg p-6 max-w-5xl">
                  ...
                  <p className="text-lg">
                    ...
                    skills in interpersonal relationships she has efficiently
                    built an effective and “quick response” team. With her vast
                    experience in the business for more than 3 decades, Ms.
                    Bhuvana drives the team to achieve and uphold the values of
                    the organisation.
                  </p>
                  <button
                    className="mt-4 bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600"
              ...
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg shadow-lg p-6 max-w-5xl">
                  ...
                  <p className="text-lg">
                    ...
                    focused on investments in the consumer retail, media, and
                    digital sectors of Southeast Asia.
                    <br />
                    <br />
            ...
            {visiblePopups.card6 && (
              <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg shadow-lg p-6 max-w-5xl">
                  ...
                  <p className="text-lg">
                    Dr. Pramod Kabra is a qualified internist (MD, Internal
                    Medicine) with management education from IIM Ahmedabad, and
                    having 20+ years of experience in Business Management,
                    Strategic Management, Drug Development, Pharma Marketing,
                    and Clinical Research across Asia Pacific.
                    <br />
                    <br />
                    Before joining CPC as Chief Executive Officer, Pramod worked
                    on various assignments at Thermo Fisher Scientific for
                    almost ten years. His last assignment was Director of
                    Healthcare (Specialty Diagnostic) business for South Asia.
                    He built a strong team that led to turning around business,
                    resulting in a high double-digit CAGR for five years. In
                    addition to this, he has been managing the EU GMP-approved
                    manufacturing and supply chain facility for clinical trial
                    supplies in the capacity of Managing Director of business.
                    He also worked Govt Relationship and Corporate Account
                    Management role at Thermo Fisher.
                    <br />
                    <br />
                    Before Thermo Fisher, Pramod has been managing Clinical
                    Research operations for PRA Health Sciences, Reliance Life
                    Sciences, and various senior management roles in Cadila
                    Pharma.
                  </p>
                  <button
                    className="mt-4 bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600"
  ...
  <iframe width="560" height="315" src="https://www.youtube.com/embed/mNYxQo9i7gc?si=YU-uCPFqkHFv2bzj" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      ...
      <div className="grid md:grid-cols-12 sm:grid-cols-2  gap-2 mt-10 animate-fade-up delay-200  overflow-x-hidden">
        <div className="md:col-span-6 col-span-12 md:ml-10 p-3 text-justify">
          <h2 className="text-maincol md:text-3xl text-left text-2xl font-semibold mt-20 font-poppins">
            Awards
          </h2>
          <p className="leading-8 mt-4 text-fontextra">
            Our commitment to excellence and innovation has earned us numerous
            prestigious awards. These accolades honor our pioneering
            advancements in diagnostic technology, exceptional customer service,
            and rigorous quality standards. Our achievements highlight our
            commitment to delivering top-tier diagnostic solutions and
            outstanding support to our clients. Each award reinforces our
            position as a leader in the medical laboratory and equipment
            manufacturing industry, symbolizing our relentless pursuit of

...
{load?<Loader/>:    
  ...
  <div className="sticky top-0">
    ...
    />
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 -scroll-mt-20 mt-20 max-w-[1300px] mx-auto ">
        ...
        <div className="grid  sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-5 mt-10">
          <div className=" p-5 bg-cover bg-no-repeat shadow-md">
            <img
          ...
          <div className="shadow-md p-5 bg-cover bg-no-repeat">
            <img
  ...
  <iframe width="560" height="315" src="https://www.youtube.com/embed/mNYxQo9i7gc?si=YU-uCPFqkHFv2bzj" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
      ...
      {/* <div className="md:col-span-6 col-span-12 md:ml-10 p-3 text-justify">
          ...
          to delivering top-tier diagnostic solutions and outstanding support to our clients. Each award
          reinforces our position as a leader in the medical laboratory and equipment manufacturing
          industry, symbolizing our relentless pursuit of quality, integrity, and innovation.

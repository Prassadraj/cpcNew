        ...
        <div className="md:pl-10 md:pr-10 mt-2 text-justify d-flex flex-column gap-3">
          ...
          <ul className="list-disc pl-5">
            ...
            <li>
              ...
              “We”, “Us” or “Our” in this Agreement) refers to CPC Diagnostics
              Pvt Ltd, No:9, 5th floor, Gokul Tower, 9 &10, CP Ramaswamy Road,
            ...
            <li>
              <strong>Website</strong> refers to CPC Diagnostics, accessible
              from{" "}
              <a href="https://cpcdiagnostics.in">https://cpcdiagnostics.in</a>
            </li>
            <li>
          ...
          <p className="text-fontextra">
            ...
            <a href="https://cpcdiagnostics.in">https://cpcdiagnostics.in</a>,
            you agreed to use cookies in agreement with CPC Diagnostics Pvt
          ...
          <p className="text-fontextra">
            Unless otherwise stated, CPC Diagnostics Pvt Ltd and/or its
            licensors own the intellectual property rights for all material on
            CPC Diagnostics website. All intellectual property rights are
            reserved. You may access this from CPC Diagnostics Pvt Ltd for your
          ...
          <p className="text-fontextra">
            This Agreement shall begin as of 20th May 2021.
          </p>
          ...
          <p className="text-fontextra">
            ...
            CPC Diagnostics Pvt Ltd does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not
            reflect the views and opinions of CPC Diagnostics Pvt Ltd, its
            ...
            permitted by applicable laws, CPC Diagnostics Pvt Ltd shall not be
          ...
          <p className="text-fontextra">
            CPC Diagnostics Pvt Ltd reserves the right to monitor all Comments
          ...
          <p className="text-fontextra">
            You hereby grant CPC Diagnostics Pvt Ltd a non-exclusive license to
          ...
          <p className="text-fontextra">
            ...
            visibility of the hyperlink compensates the absence of CPC
            Diagnostics Pvt Ltd; and (d) the link is in the context of general
          ...
          <p className="text-fontextra">
            ...
            sending an e-mail to info@cpcdiagnostics.in. Please include your
          ...
          <p className="text-fontextra">
            No use of CPC Diagnostics Pvt Ltd’s logo or other artwork will be

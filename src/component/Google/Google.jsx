            ...
            <div className="div2 p-2  ">
              ...
              <div className="leading-9">
                ...
                <p className="font-semibold text-lg">
                  MRP:
                  <span className="font-light"> 265000.00 INR / Piece </span>
                </p>
                <p className="font-semibold text-lg">
          ...
          <div class="grid grid-cols-3 gap-4 mt-4">
            <div class="col-span-2  ml-4">
              ...
              <p className="text-xl mt-8">
                ...
                <a href="">
                  {" "}
                  T3 T4 TSH के लिए पूरी तरह से स्वचालित इम्यूनोएसे हार्मोन
                  एनालाइज़र
                </a>
              </p>

              <h2 className="text-black text-xl text-left mt-4">
                Company Details
              </h2>
              <p className="mt-4">
                ...
                is a dedicated provider of products and services to the in-vitro
                diagnostics industry in India, Sri Lanka and Bangladesh. The
                experience and expertise that we have gained since we began in
                1987 have made us a respected and trusted organization. We
                derive our strength through enduring relationships with
                customers, based on our commitment to deliver valuable products
                and timely end-user support. Our motto is to grow our business
                on sustainable values, contributing to the well being of our
                customers, suppliers, technology partners and employees. The
                success of CPC Diagnostics owes a lot to its dynamic team of
                management, staff and advisers who together have worked to
                provide their customers with outstanding support be it Products,
            ...
            <div class="sticky top-10 shadow-md p-4">
              ...
              <p className="mt-8 text-sm">
                Fully Automatic Immunoassay Hormones Analyzer For T3 T4 Tsh
                Machine Weight: 6 Kilograms (Kg) Rubi Lab
              </p>
              <hr className="mt-4" />

...
import product1 from "../AllDatas/ProductImages/Biochemistry/MAGNA/product1.webp";
import product2 from "../AllDatas/ProductImages/Biochemistry/MAGNA/product2.webp";
import product3 from "../AllDatas/ProductImages/Biochemistry/MAGNA/product3.webp";
import product4 from "../AllDatas/ProductImages/Biochemistry/MAGNA/product4.webp";
import product5 from "../AllDatas/ProductImages/Biochemistry/NEO/product1.webp";
import product6 from "../AllDatas/ProductImages/Biochemistry/NEO/product2.webp";
import product7 from "../AllDatas/ProductImages/Biochemistry/NEO/product3.webp";
import product8 from "../AllDatas/ProductImages/Biochemistry/NEO/product4.webp";
import product9 from "../AllDatas/ProductImages/Biochemistry/PLUS/product1.webp";
import product10 from "../AllDatas/ProductImages/Biochemistry/PLUS/product2.webp";
import product11 from "../AllDatas/ProductImages/Biochemistry/PRIME/product1.webp";
import product12 from "../AllDatas/ProductImages/Biochemistry/PRIME/product2.webp";
...
function Google() {
  ...
  const [isFormVisible, setFormVisible] = useState(false); // For Popupform
  const [isAdsVisible, setAdsVisible] = useState(false); // For Popupads
  const [isNumberVisible, setNumberVisible] = useState(false);
  const existingNumber = "+ 91 6432167523";

  const toggleFormPopup = () => setFormVisible(!isFormVisible);
  const toggleAdsPopup = () => setAdsVisible(!isAdsVisible);
  ...
  const handleFormSubmit = () => {
    setNumberVisible(true); // Show the number after form submission
  };
  ...
  return (
    <div>
      <div className="grid lg:grid-cols-3 grid-cols-1">
        ...
        <div className="div2 p-2  ">
          ...
          <div className="flex justify-between gap-2  mt-4">
            <button
              className="border-maincol border-2  p-2  rounded-full bg-maincol flex justify-center items-center gap-2  text-xl text-white w-full"
        ...
        <div className="bg-gray-200 p-4">
          <p className="text-black text-left text-2xl font-poppins font-semibold">
            Seller Details
          </p>
          <a href="">
            <div className="flex gap-4 items-center mt-4">
              <div>
                <p className="border-green-400 border-2  p-4 rounded-lg bg-custom-green text-white mt-2 ">
                  CPC
                </p>
              </div>
              <div>
          ...
          <div className="flex mt-4 gap-2 ">
            <div>
              {/* If the number is visible, show it; otherwise, show the "View Number" button */}
              {isNumberVisible ? (
                <div className="border-maincol border-2 p-2 rounded-full flex justify-center items-center gap-2 text-sm w-full">
                  {existingNumber}
                </div>
              ) : (
                <button
                  className="border-maincol border-2 p-2 rounded-full flex justify-center items-center gap-2 text-sm "
                  onClick={toggleAdsPopup}
                >
              ...
              {/* Popupads component */}
              <Popupads
                isVisible1={isAdsVisible}
                onClose1={toggleAdsPopup}
                onSubmitForm={handleFormSubmit}
              />
            </div>

            <button className="border-maincol border-2  p-2  rounded-full flex justify-center items-center gap-2  text-sm">
      ...
      <div class="grid grid-cols-3 gap-4 mt-4">
        <div class="lg:col-span-2 col-span-12  ml-4">
          ...
          <div className="product-container grid lg:grid-cols-4 grid-cols-1 mt-4 gap-3">
            <div className="border border-green-400 p-2 shadow-md rounded-md">
              <img src={product1} alt="" className="lg:h-44" />
              <div>
            ...
            <div className="border border-green-400 p-2 shadow-md rounded-md">
              <img src={product2} alt="" className="lg:h-44" />
              <div>
                <h2 className="text-black text-left mt-4 text-lg">
                  TurboChem Magna
                </h2>
            ...
            <div className="border border-green-400 p-2 shadow-md rounded-md">
              <img src={product3} alt="" className="lg:h-44" />
              <div>
                <h2 className="text-black text-left mt-4 text-lg">
                  TurboChem Magna
                </h2>
            ...
            <div className="border border-green-400 p-2 shadow-md rounded-md">
              <img src={product4} alt="" className="lg:h-44" />
              <div>
                <h2 className="text-black text-left mt-4 text-lg">
                  TurboChem Magna
                </h2>
            ...
            <div className="border border-green-400 p-2 shadow-md rounded-md">
              <img src={product5} alt="" className="lg:h-44" />
              <div>
                <h2 className="text-black text-left mt-4 text-lg">
                  TurboChem NEO
                </h2>
            ...
            <div className="border border-green-400 p-2 shadow-md rounded-md">
              <img src={product6} alt="" className="lg:h-44" />
              <div>
                <h2 className="text-black text-left mt-4 text-lg">
                  TurboChem NEO
                </h2>
            ...
            <div className="border border-green-400 p-2 shadow-md rounded-md">
              <img src={product7} alt="" className="lg:h-44" />
              <div>
                <h2 className="text-black text-left mt-4 text-lg">
                  TurboChem NEO
                </h2>
            ...
            <div className="border border-green-400 p-2 shadow-md rounded-md">
              <img src={product8} alt="" className="lg:h-44" />
              <div>
                <h2 className="text-black text-left mt-4 text-lg">
                  TurboChem NEO
                </h2>
                ...
                <button
                  className="border-maincol mt-3 border-2  p-2  rounded-full bg-maincol flex justify-center items-center gap-2   text-white w-full"
            ...
            <div className="border border-green-400 p-2 shadow-md rounded-md">
              <img src={product9} alt="" className="lg:h-44" />
              <div>
                <h2 className="text-black text-left mt-4 text-lg">
                  TurboChem PLUS
                </h2>
            ...
            <div className="border border-green-400 p-2 shadow-md rounded-md">
              <img src={product10} alt="" className="lg:h-44" />
              <div>
                <h2 className="text-black text-left mt-4 text-lg">
                  TurboChem PLUS
                </h2>
            ...
            <div className="border border-green-400 p-2 shadow-md rounded-md">
              <img src={product11} alt="" className="lg:h-44" />
              <div>
                <h2 className="text-black text-left mt-4 text-lg">
                  TurboChem PRIME
                </h2>
            ...
            <div className="border border-green-400 p-2 shadow-md rounded-md">
              <img src={product12} alt="" className="lg:h-44" />
              <div>
                <h2 className="text-black text-left mt-4 text-lg">
                  TurboChem PRIME
                </h2>
          ...
          <div className="product-container grid lg:grid-cols-4 grid-cols-1 mt-4 gap-4">
            <a href="">
      ...
      <div className="grid lg:grid-cols-5 grid-cols-1 gap-4 p-2  mt-8">
        <div className="border border-green-400 p-2 shadow-md rounded-md">
          <img src={product1} alt="" className="lg:h-44" />
          <div>
            <h2 className="text-black text-left mt-4 text-lg">

...
import image2 from "../AllDatas/ProductImages/Hematology/SedratePro/product1.jpg";
import image3 from "../AllDatas/ProductImages/Immunology/Iflash1200/product1.jpg";
          ...
          {slide.map((s, index) => (
            ...
            >
              <Link
                ...
                to={`/productinfo/${s.category}/${s.id}`}
              >
                <img
                  src={s.url}
                  alt={s.category}
